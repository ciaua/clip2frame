# -*- coding: utf-8 -*-
#
# clip2frame documentation build configuration file, created by
...
project = u'clip2frame'
copyright = u'2016, Jen-Yu Liu'
author = u'Jen-Yu Liu'
...
#
# html_title = u'clip2frame v0.1.0'
...
htmlhelp_basename = 'clip2framedoc'
...
latex_documents = [
    (master_doc, 'clip2frame.tex', u'clip2frame Documentation',
     u'Jen-Yu Liu', 'manual'),
]
...
man_pages = [
    (master_doc, 'clip2frame', u'clip2frame Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'clip2frame', u'clip2frame Documentation',
     author, 'clip2frame', 'One line description of project.',
     'Miscellaneous'),
]
