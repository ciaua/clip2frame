...
if __name__ == '__main__':
    feat_tr_fp = 'data.magnatagatune/sample_exp_data/feat.tr.scale0.npy'
    feat_va_fp = 'data.magnatagatune/sample_exp_data/feat.va.scale0.npy'
    feat_te_fp = 'data.magnatagatune/sample_exp_data/feat.te.scale0.npy'
